import{t as C,v as w,w as _,g as S,ab as x,cd as A,e as t,d as e,G as m,T as a,ar as O,M as f,h as u,cf as k,ce as s,O as o,N as d,r as D,cg as G,ch as l,S as B,cj as c,ck as y,f as $,x as g,cl as T,a1 as R,bF as I,c4 as M,a as P,bM as N,b9 as j,cm as W,cn as V}from"./index-B1rGVSVQ.js";var p={},b;function q(){if(b)return p;b=1;var n=C();Object.defineProperty(p,"__esModule",{value:!0}),p.default=void 0;var i=n(w()),r=_(),h=(0,i.default)((0,r.jsx)("path",{d:"M16.01 11H4v2h12.01v3L20 12l-3.99-4z"}),"ArrowRightAlt");return p.default=h,p}var L=q();const v=S(L);function re(){x.send({hitType:"pageview",page:"/doc"});const{params:{currentTab:n}}=A("/doc/:currentTab")??{params:{currentTab:""}};return t(u,{children:[t(m,{container:!0,sx:{px:2,py:1},children:[e(m,{item:!0,flexGrow:1,children:e(a,{variant:"h6",children:"Documentation"})}),e(m,{item:!0,children:e(a,{variant:"h6",children:e(O,{color:"info",children:"Version. 2"})})})]}),e(f,{}),e(d,{children:t(m,{container:!0,spacing:1,children:[e(m,{item:!0,xs:12,md:2,children:e(u,{bgt:"light",sx:{height:"100%"},children:t(k,{orientation:"vertical",value:n,"aria-label":"Documentation Navigation",sx:{borderRight:1,borderColor:"divider"},children:[e(s,{label:"Overview",value:"",component:o,to:""}),e(s,{label:"Key naming convention",value:"KeyNaming",component:o,to:"KeyNaming"}),e(s,{label:e("code",{children:"StatKey"}),value:"StatKey",component:o,to:"StatKey"}),e(s,{label:e("code",{children:"ArtifactSetKey"}),value:"ArtifactSetKey",component:o,to:"ArtifactSetKey"}),e(s,{label:e("code",{children:"CharacterKey"}),value:"CharacterKey",component:o,to:"CharacterKey"}),e(s,{label:e("code",{children:"WeaponKey"}),value:"WeaponKey",component:o,to:"WeaponKey"}),e(s,{label:e("code",{children:"MaterialKey"}),value:"MaterialKey",component:o,to:"MaterialKey"}),e(s,{label:"Version History",value:"VersionHistory",component:o,to:"VersionHistory"})]})})}),e(m,{item:!0,xs:12,md:10,children:e(u,{bgt:"light",sx:{height:"100%"},children:e(d,{children:e(D.Suspense,{fallback:e(B,{variant:"rectangular",width:"100%",height:600}),children:t(G,{children:[e(l,{index:!0,element:e(J,{})}),e(l,{path:"/VersionHistory",element:e(te,{})}),e(l,{path:"/MaterialKey",element:e(ee,{})}),e(l,{path:"/ArtifactSetKey",element:e(X,{})}),e(l,{path:"/WeaponKey",element:e(Z,{})}),e(l,{path:"/CharacterKey",element:e(Y,{})}),e(l,{path:"/StatKey",element:e(U,{})}),e(l,{path:"/KeyNaming",element:e(Q,{})})]})})})})})]})})]})}const H=`interface IGOOD {
...
type SlotKey = "flower" | "plume" | "sands" | "goblet" | "circlet"`,z=`interface IWeapon {
  ...
  | `)}`;return t(y,{children:[e(a,{gutterBottom:!0,variant:"h4",children:"ArtifactSetKey"}),e(c,{text:i})]})}function Y(){const{t:n}=g("charNames_gen"),i=P(),{gender:r}=N(),h=`type CharacterKey
  = ${[...new Set(j)].sort().map(K=>`"${K}" //${n(`charNames_gen:${W(i.chars.LocationToCharacterKey(K),r)}`)}`).join(`
