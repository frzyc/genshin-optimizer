...
type SlotKey = "flower" | "plume" | "sands" | "goblet" | "circlet"`,F=`interface IWeapon {
  ...
  = ${[...new Set(M)].sort().map(K=>`"${K}" //${o(`charNames_gen:${P(s.chars.LocationToCharacterKey(K),i)}`)}`).join(`
