...
type SlotKey = "flower" | "plume" | "sands" | "goblet" | "circlet"`,F=`interface IWeapon {
  ...
  | `)}`;return t(u,{children:[e(a,{gutterBottom:!0,variant:"h4",children:"StatKey"}),e(n,{children:e(r,{children:e(l,{text:i})})})]})}function U(){const{t:o}=y("artifactNames_gen"),s=`type ArtifactSetKey
  ...
  = ${[...new Set(P)].sort().map(v=>`"${v}" //${o(`charNames_gen:${W(s.chars.LocationToCharacterKey(v),i)}`)}`).join(`
