...
type SlotKey = "flower" | "plume" | "sands" | "goblet" | "circlet"`,F=`interface IWeapon {
  ...
  | `)}`;return t(y,{children:[e(a,{gutterBottom:!0,variant:"h4",children:"ArtifactSetKey"}),e(c,{text:i})]})}function Y(){const{t:n}=g("charNames_gen"),i=M(),{gender:r}=P(),h=`type CharacterKey
  = ${[...new Set(N)].sort().map(K=>`"${K}" //${n(`charNames_gen:${j(i.chars.LocationToCharacterKey(K),r)}`)}`).join(`
  ...
  = ${[...new Set(R)].sort().map(r=>`"${r}" //${n(`weaponNames_gen:${r}`)}`).join(`
  ...
  | `)}`;return t(y,{children:[e(a,{gutterBottom:!0,variant:"h4",children:"MaterialKey"}),t(a,{gutterBottom:!0,children:["The item names are taken from the english translation, and then converted into"," ",e(V,{component:o,to:"KeyNaming",children:e("code",{children:"PascalCase"})}),"."]}),e(c,{text:i})]})}function te(){return t($,{display:"flex",flexDirection:"column",gap:2,children:[e(a,{gutterBottom:!0,variant:"h4",children:"Version History"}),t(u,{children:[e(d,{children:e(a,{children:"Version 1"})}),e(f,{}),e(d,{children:t(a,{children:["Created general ",e("code",{children:"IGOOD"})," format with character, weapon, artifact fields."]})})]}),t(u,{children:[e(d,{children:e(a,{children:"Version 2"})}),e(f,{}),e(d,{children:t(a,{children:["Adds ",e("code",{children:"materials"})," field to ",e("code",{children:"IGOOD"}),". All other fields remain the same. V2 is backwards compatible with V1."]})})]})]})}export{ne as default};
