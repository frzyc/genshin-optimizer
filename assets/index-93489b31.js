import{c as b,j as C,M as S,aj as w,n as t,J as m,p as e,T as a,D as g,s as v,ak as x,al as d,L as c,C as r,e as _,W as A,am as k,an as h,t as n,ao as l,ap as u,u as p,aq as O,b as B,d as D,ar as G,as as $,at as T,au as M,K as P}from"./index-390a6a3f.js";import{S as W}from"./SqBadge-a845c0f4.js";import{a as I}from"./Artifact-d4a0b0a3.js";import{L as N}from"./Link-55394abd.js";const K=b(C.jsx("path",{d:"M16.01 11H4v2h12.01v3L20 12l-3.99-4z"}),"ArrowRightAlt");function te(){S.send({hitType:"pageview",page:"/doc"});const{params:{currentTab:o}}=w("/doc/:currentTab")??{params:{currentTab:""}};return t(n,{sx:{my:1},children:[t(m,{container:!0,sx:{px:2,py:1},children:[e(m,{item:!0,flexGrow:1,children:e(a,{variant:"h6",children:"Documentation"})}),e(m,{item:!0,children:e(a,{variant:"h6",children:e(W,{color:"info",children:"Version. 2"})})})]}),e(g,{}),e(r,{children:t(m,{container:!0,spacing:1,children:[e(m,{item:!0,xs:12,md:2,children:e(v,{sx:{height:"100%"},children:t(x,{orientation:"vertical",value:o,"aria-label":"Documentation Navigation",sx:{borderRight:1,borderColor:"divider"},children:[e(d,{label:"Overview",value:"",component:c,to:""}),e(d,{label:"Key naming convention",value:"KeyNaming",component:c,to:"KeyNaming"}),e(d,{label:e("code",{children:"StatKey"}),value:"StatKey",component:c,to:"StatKey"}),e(d,{label:e("code",{children:"ArtifactSetKey"}),value:"ArtifactSetKey",component:c,to:"ArtifactSetKey"}),e(d,{label:e("code",{children:"CharacterKey"}),value:"CharacterKey",component:c,to:"CharacterKey"}),e(d,{label:e("code",{children:"WeaponKey"}),value:"WeaponKey",component:c,to:"WeaponKey"}),e(d,{label:e("code",{children:"MaterialKey"}),value:"MaterialKey",component:c,to:"MaterialKey"}),e(d,{label:"Version History",value:"VersionHistory",component:c,to:"VersionHistory"})]})})}),e(m,{item:!0,xs:12,md:10,children:e(v,{sx:{height:"100%"},children:e(r,{children:e(_.Suspense,{fallback:e(A,{variant:"rectangular",width:"100%",height:600}),children:t(k,{children:[e(h,{index:!0,element:e(H,{})}),e(h,{path:"/VersionHistory",element:e(U,{})}),e(h,{path:"/MaterialKey",element:e(Q,{})}),e(h,{path:"/ArtifactSetKey",element:e(F,{})}),e(h,{path:"/WeaponKey",element:e(J,{})}),e(h,{path:"/CharacterKey",element:e(E,{})}),e(h,{path:"/StatKey",element:e(q,{})}),e(h,{path:"/KeyNaming",element:e(z,{})})]})})})})})]})})]})}const j=`interface IGOOD {
...
type SlotKey = "flower" | "plume" | "sands" | "goblet" | "circlet"`,V=`interface IWeapon {
  ...
  = ${["hp","hp_","atk","atk_","def","def_","eleMas","enerRech_","heal_","critRate_","critDMG_","physical_dmg_","anemo_dmg_","geo_dmg_","electro_dmg_","hydro_dmg_","pyro_dmg_","cryo_dmg_","dendro_dmg_"].map(y=>`"${y}" //${o(y)}${I(y)}`).join(`
