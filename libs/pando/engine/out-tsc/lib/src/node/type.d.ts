...
export type OP = 'const' | 'sum' | 'prod' | 'min' | 'max' | 'sumfrac' | 'subscript' | 'lookup' | 'thres' | 'match' | 'tag' | 'dtag' | 'vtag' | 'read' | 'custom';
 ...
 */
export interface Custom<Output, PermitOP extends OP = OP> extends Base<'custom' & PermitOP, Output> {
    ex: string;
}
export type NumNode<PermitOP extends OP = OP> = Const<number> | Sum<PermitOP> | Prod<PermitOP> | Max<PermitOP> | Min<PermitOP> | SumFrac<PermitOP> | Threshold<NumNode<PermitOP>, PermitOP> | Match<NumNode<PermitOP>, PermitOP> | Lookup<NumNode<PermitOP>, PermitOP> | Subscript<number, PermitOP> | TagOverride<NumNode<PermitOP>, PermitOP> | DynamicTag<NumNode<PermitOP>, PermitOP> | BaseRead | Custom<NumNode<PermitOP>, PermitOP>;
export type StrNode<PermitOP extends OP = OP> = Const<string> | Threshold<StrNode<PermitOP>, PermitOP> | Match<StrNode<PermitOP>, PermitOP> | Lookup<StrNode<PermitOP>, PermitOP> | Subscript<string, PermitOP> | TagOverride<StrNode<PermitOP>, PermitOP> | DynamicTag<StrNode<PermitOP>, PermitOP> | TagValRead<PermitOP> | BaseRead | Custom<StrNode<PermitOP>, PermitOP>;
export type AnyNode<PermitOP extends OP = OP> = Const<number | string> | Sum<PermitOP> | Prod<PermitOP> | Max<PermitOP> | Min<PermitOP> | SumFrac<PermitOP> | Threshold<AnyNode<PermitOP>, PermitOP> | Match<AnyNode<PermitOP>, PermitOP> | Lookup<AnyNode<PermitOP>, PermitOP> | Subscript<number | string, PermitOP> | TagOverride<AnyNode<PermitOP>, PermitOP> | DynamicTag<AnyNode<PermitOP>, PermitOP> | TagValRead<PermitOP> | BaseRead | Custom<AnyNode<PermitOP>, PermitOP>;
