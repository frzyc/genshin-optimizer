...
export const allElementKeys = ['anemo', 'geo', 'electro', 'hydro', 'pyro', 'cryo', 'dendro'] as const
...
export const allRegionKeys = ['mondstadt', 'liyue', 'inazuma', 'sumeru', 'fontaine', 'natlan', 'snezhnaya', 'khaenriah'] as const
...
export const allMoveKeys = ['normal', 'charged', 'plunging', 'skill', 'burst', 'elemental'] as const
