...
export function cmpGE(v1: Num, v2: Num, ge: Val, lt: Val = 0): Threshold<AnyNode> {
...
export function cmpLT(v1: Num, v2: Num, lt: Val, ge: Val = 0): Threshold<AnyNode> {
  return thres(v1, v2, ge, lt)
}
/** v1 <= v2 ? le : gt */
...
export function cmpLE(v1: Num, v2: Num, le: Val, gt: Val = 0): Threshold<AnyNode> {
...
export function cmpGT(v1: Num, v2: Num, gt: Val, le: Val = 0): Threshold<AnyNode> {
  return thres(v2, v1, le, gt)
}
