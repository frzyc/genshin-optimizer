...
export function compileTagMapValues<V>(
  _keys: CompiledTagMapKeys,
  entries: RawTagMapEntries<V>
): CompiledTagMapValues<V> {
  const keys = new TagMapKeys(_keys),
    tagLen = keys.tagLen,
    result: CompiledTagMapValues<V> = {}
...
export function mergeTagMapValues<V>(
  entries: CompiledTagMapValues<V>[]
): CompiledTagMapValues<V> {
...
export function compileTagMapEntries<V>(entries: RawTagMapEntries<V>): {
  keys: CompiledTagMapKeys
  values: CompiledTagMapValues<V>
} {
