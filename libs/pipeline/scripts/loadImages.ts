import { artifactIdMap, artifactSlotMap, characterIdMap, weaponIdMap, weaponMap } from '../src/lib/pipeline'
...
import { crawlObject, DM2D_PATH, dumpFile, FRONTEND_PATH, layeredAssignment } from './Util'
