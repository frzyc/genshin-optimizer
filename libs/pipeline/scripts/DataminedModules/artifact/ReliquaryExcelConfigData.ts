import { DArtifactSlotKey } from "../../../src/lib/pipeline"
import { nameToKey, TextMapEN } from "../../TextMapUtil"
import { dumpFile, readDMJSON } from "../../Util"
...
const artifactPiecesDataSrc = JSON.parse(readDMJSON("ExcelBinOutput/ReliquaryExcelConfigData.json")) as ReliquaryExcelConfigData[]
