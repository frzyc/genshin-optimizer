import { CharacterId } from "../../../src/lib/pipeline"
...
const skillDepotSrc = JSON.parse(readDMJSON("ExcelBinOutput/AvatarSkillDepotExcelConfigData.json")) as AvatarSkillDepotExcelConfigData[]
