import { CharacterGrowCurveKey, CharacterId, DQualityKey, DWeaponTypeKey } from "../../../src/lib/pipeline"
...
const avatarExcelConfigData = Object.fromEntries(avatarExcelConfigDataSrc.map(data =>
  [data.id, data])) as { [charId: CharacterId | number]: AvatarExcelConfigData }
