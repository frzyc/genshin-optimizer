...
import { allConditionals, enemyDebuff, percent, register, self, selfBuff, team, teamBuff } from '../../util'
...
const { a1AfterSkill, a1AfterHit, c2Hydro, c2Dendro, c4AfterPirHit } = allConditionals(info.key)
