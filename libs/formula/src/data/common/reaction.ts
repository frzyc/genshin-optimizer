...
import { Data, Element, percent, self, selfBuff, TransReaction } from '../util'
...
type TransInfo = { multi: number, variants: Element[], resist: Element, canCrit: boolean }
const transReactionInfo: Record<TransReaction, TransInfo> = {
