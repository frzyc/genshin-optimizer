...
describe('example', () => {
  const data: Data = [
    ...
    ...withMember('member0',
      ...charData({
        name: 'Nahida', lvl: 12, ascension: 0, constellation: 2, conds: {
          a1ActiveInBurst: 'off', c2Bloom: 'on', c2QSA: 'off', c4Count: 'off'
        }
      }),
      ...weaponData({
        name: 'TulaytullahsRemembrance', lvl: 42, ascension: 2, refinement: 2, conds: {
    ...
    ...withMember('member1',
      ...charData({
        name: 'Nilou', lvl: 33, ascension: 1, constellation: 3, conds: {
          a1AfterSkill: 'off', a1AfterHit: 'off',
          c2Hydro: 'off', c2Dendro: 'off', c4AfterPirHit: 'off'
        }
      }),
      ...weaponData({
        name: 'KeyOfKhajNisut', lvl: 59, ascension: 3, refinement: 3, conds: {
          afterSkillStacks: 3
        }
      }),
      ...artifactsData([/* per art stat */], { /* conditionals */ }),
