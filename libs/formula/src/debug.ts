import { AnyNode, ReRead, TagMapExactValues, TagMapKeys, TagMapSubsetCache, traverse } from '@genshin-optimizer/waverider'
import { Calculator } from './calculator'
import { keys } from './data'
import { Read, Tag } from './data/util'
...
export function listDependencies(tag: Tag, calc: Calculator): { tag: Tag, read: Tag[], reread: Tag[] }[] {
