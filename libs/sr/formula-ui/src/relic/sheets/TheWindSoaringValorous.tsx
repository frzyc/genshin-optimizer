...
const key: RelicSetKey = 'TheWindSoaringValorous'
      ...
      },
      {
        ...
        conditional: {
          header: {
            ...
            text: 'Use a Follow-up ATK', // TODO: L10n
            additional: <SqBadge>4-Set</SqBadge>, // TODO: L10n
          },
          metadata: cond.followUpUsed,
          label: '4-Set',
          fields: [
            {
              // TODO: change to ult dmg
              title: <StatDisplay statKey="dmg_" />,
              fieldRef: buff.set4_ult_dmg_.tag,
            },
