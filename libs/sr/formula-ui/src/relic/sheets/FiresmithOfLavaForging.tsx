  ...
  2: {
    ...
    documents: [
      ...
      },
      {
        ...
        fields: [
          {
            title: <StatDisplay statKey="fire_dmg_" />,
            fieldRef: buff.set2_passive_fire_dmg_.tag,
          },
        ],
      },
    ],
  ...
  4: {
    ...
    documents: [
      ...
      },
      {
        ...
        fields: [
          {
            // TODO: change to skill dmg
            title: <StatDisplay statKey="dmg_" />,
            fieldRef: buff.set4_skill_dmg_.tag,
          },
        ],
      },
      {
        ...
        conditional: {
          ...
          fields: [
            {
              title: <StatDisplay statKey="fire_dmg_" />,
              fieldRef: buff.set4_fire_dmg_.tag,
            },
          ],
        },
      },
