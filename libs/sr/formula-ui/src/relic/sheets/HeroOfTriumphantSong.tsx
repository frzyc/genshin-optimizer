    ...
    documents: [
      ...
      },
      {
        ...
        conditional: {
          header: {
            ...
            text: 'Memosprite is on the field', // TODO: L10n
            additional: <SqBadge>4-Set</SqBadge>, // TODO: L10n
          },
          metadata: cond.memospriteOnField,
          label: '4-Set',
          fields: [
            {
              title: <StatDisplay statKey="spd_" />,
              fieldRef: buff.set4_spd_.tag,
            },
          ],
        },
      },
      {
        ...
        conditional: {
          header: {
            icon: <ImgIcon src={icon} />,
            text: 'Memosprite has attacked', // TODO: L10n
            additional: <SqBadge>4-Set</SqBadge>, // TODO: L10n
          },
          metadata: cond.memospriteAttacks,
          label: '4-Set',
          fields: [
            {
