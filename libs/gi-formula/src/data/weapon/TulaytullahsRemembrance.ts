...
import { allNumConditional, percent, register, self, selfBuff } from '../util'
...
const { timePassive } = allNumConditional(key, 'sum', false, 0, 12)
const { hitPassive } = allNumConditional(key, 'sum', true, 0, 5)
