...
const dm = {
  ...
  core: {
    ...
    dmg_wind: data_gen.coreParams[5],
    anomProf_step: data_gen.coreParams[6][0],
    dmg: data_gen.coreParams[7][0],
    cooldown: data_gen.coreParams[8][0],
    flight_feathers: data_gen.coreParams[9][0],
  },
  ability: {
