...
import { ChaosJazz } from '@genshin-optimizer/zzz/formula'
    ...
    documents: [
      ...
      },
      {
        ...
        conditional: {
          ...
          fields: [
            tagToTagField(buff.set4_off_field_special_dmg_.tag),
            tagToTagField(buff.set4_off_field_assist_dmg_.tag),
          ],
        },
      },
    ],
