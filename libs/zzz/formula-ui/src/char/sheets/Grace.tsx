      ...
      Pulse: [
        {
          ...
          conditional: {
            ...
            fields: [
              fieldForBuff(buff.special_ether_abloom),
              fieldForBuff(buff.special_electric_abloom),
              fieldForBuff(buff.special_fire_abloom),
              fieldForBuff(buff.special_physical_abloom),
              fieldForBuff(buff.special_ice_abloom),
            ],
          },
        },
      ],
