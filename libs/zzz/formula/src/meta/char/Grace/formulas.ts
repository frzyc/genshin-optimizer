...
export const formulas = {
  ...
  SpecialAttackObstructionRemovalCycle_0_dmg: {
    sheet: 'Grace',
    name: 'SpecialAttackObstructionRemovalCycle_0_dmg',
    tag: {
      et: 'own',
      qt: 'formula',
      q: 'standardDmg',
  ...
  SpecialAttackObstructionRemovalCycle_0_daze: {
    sheet: 'Grace',
    name: 'SpecialAttackObstructionRemovalCycle_0_daze',
    tag: {
      et: 'own',
      qt: 'formula',
      q: 'dazeBuildup',
  ...
  SpecialAttackObstructionRemovalCycle_0_anomBuildup: {
    sheet: 'Grace',
    name: 'SpecialAttackObstructionRemovalCycle_0_anomBuildup',
    tag: {
      et: 'own',
      qt: 'formula',
      q: 'anomBuildup',
