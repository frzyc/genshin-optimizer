...
const fetterCharacterCardExcelConfigDataSrc = JSON.parse(readDMJSON("ExcelBinOutput/FetterCharacterCardExcelConfigData.json")) as FetterCharacterCardExcelConfigData[]
//character data
