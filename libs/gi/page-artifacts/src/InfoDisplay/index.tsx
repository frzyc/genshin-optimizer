...
import { ImgFullwidth, SqBadge } from '@genshin-optimizer/common/ui'
import { range } from '@genshin-optimizer/common/util'
import { SmolProgress } from '@genshin-optimizer/gi/ui'
    ...
    <Grid container spacing={1}>
      ...
      <Grid item xs={12} lg={7} xl={8}>
        <Trans t={t} i18nKey="info.section1">
          ...
          <Typography gutterBottom>
            The <b>number of rolls</b> a substat has is shown to the left of the
            substat. As the number gets higher, the substat is more colorful:
            <Colors />.
          </Typography>
          ...
          <Typography variant="h5">
            Current Roll Value vs. Maximum Roll Value
          </Typography>
          <Typography gutterBottom>
            When a 5<StarRoundedIcon {...iconInlineProps} /> have 9(4+5) total
            rolls, with each of the rolls having the highest value, that is
            defined as a 900% RV artifact. However, most of the artifacts are
            not this lucky. The <b>Current RV</b> of an artifact is a percentage
            over that 100% artifact. The <b>Maximum RV</b> is the maximum
            possible RV an artifact can achieve, if the remaining artifact rolls
            from upgrades are the hightest possible value.
          </Typography>
        </Trans>
      </Grid>
      <Grid item xs={12} lg={6} xl={7}>
        <Trans t={t} i18nKey="info.section2">
          ...
          <Typography gutterBottom>
            ...
            <StarRoundedIcon {...iconInlineProps} /> to 5
            <StarRoundedIcon {...iconInlineProps} /> Artifact. When a substat is
            inputted, it can calculate the exact roll values. It will also make
            sure that you have the correct number of rolls in the artifact
            according to the level, along with other metrics of validation.
          </Typography>
          ...
          <Typography>
            ...
            will allow you to compare the two artifacts in question(See Image).
          </Typography>
        </Trans>
      </Grid>
      ...
      <Grid item xs={12} lg={5} xl={6}>
        <Trans t={t} i18nKey="info.section3">
          ...
          <Typography variant="h5">
            Example: Finding Fodder Artifacts
          </Typography>
          <Typography>
            By utilizing the artifact filter, and the artifact RV, you can
            quickly find artifacts to feed as food.
          </Typography>
          ...
          <Typography component="div">
            <ul>
              ...
              <li>
                Removing the contribution of flat HP, flat DEF and Energy
                Recharge to RV calculations.
              </li>
              <li>Sorted by Ascending Max Roll Value.</li>
            </ul>
          </Typography>
          <Typography>
            This will filter the artifact Inventory by the lowest RV artifacts,
            for desired substats.
          </Typography>
        </Trans>
      </Grid>
    </Grid>
