...
const formula = formulas.SangonomiyaKokomi
const cond = conditionals.SangonomiyaKokomi
...
const sheet: UISheet<TalentSheetElementKey> = {
      ...
      fields: [
        {
          ...
          fieldRef: formula.burst_normal_dmgInc.tag,
        },
        {
          title: ct.chg('burst.skillParams.2'),
          fieldRef: formula.burst_charged_dmgInc.tag,
        },
        {
          title: ct.chg('burst.skillParams.3'),
          fieldRef: formula.burst_skill_dmgInc.tag,
        },
        {
  ...
  constellation2: ct.talentTem('constellation2', [
    charConditionalDocument(key, cond.c2, {
      ...
      fields: [
        {
          title: ct.ch('c2SkillHeal'),
          fieldRef: formula.skill_heal.tag,
        },
        {
          title: ct.ch('c2BurstHeal'),
          fieldRef: formula.burst_heal.tag,
        },
      ],
    }),
  ...
  constellation4: ct.talentTem('constellation4', [
    {
      ...
      fields: [
        {
          title: st('enerRegenPerHit'),
          fieldRef: formula.c4_energy.tag,
          toFixed: 1,
        },
      ],
    },
