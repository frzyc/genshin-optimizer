...
const formula = formulas.Dahlia
const cond = conditionals.Dahlia
...
const sheet: UISheet<TalentSheetElementKey> = {
  ...
  burst: ct.talentTem('burst', [
    {
      ...
      fields: [
        ...
        {
          title: ct.chg('burst.skillParams.1'),
          fieldRef: formula.burst_hydroShield.tag,
        },
        {
  ...
  passive2: ct.talentTem('passive2', [
    charConditionalDocument(key, cond.burstActive, {
      teamBuff: true,
      label: ct.ch('burstActiveCond'),
    }),
  ]),
  passive3: ct.talentTem('passive3'),
  constellation1: ct.talentTem('constellation1'),
  constellation2: ct.talentTem('constellation2', [
    charConditionalDocument(key, cond.c2BurstConsumed, {
      teamBuff: true,
      label: ct.ch('c2Cond'),
      fields: [
        {
