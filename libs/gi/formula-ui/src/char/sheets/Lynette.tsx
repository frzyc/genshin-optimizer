...
const formula = formulas.Lynette
const cond = conditionals.Lynette
...
const sheet: UISheet<TalentSheetElementKey> = {
  ...
  skill: ct.talentTem('skill', [
    {
      ...
      fields: [
        ...
        },
        {
          ...
          fieldRef: formula.skill_hpRegen.tag,
        },
        {
        ...
        },
        {
          ...
          unit: 's',
          fieldRef: formula.skill_holdMaxDuration.tag,
        },
        {
          title: stg('cd'),
          unit: 's',
  ...
  burst: ct.talentTem('burst', [
    {
      ...
      fields: [
        ...
        },
        {
          ...
          unit: 's',
          fieldRef: formula.burst_boxDuration.tag,
        },
        {
          title: stg('cd'),
          unit: 's',
    ...
    charConditionalDocument(key, cond.burstAbsorb, {
      label: st('eleAbsor'),
    }),
  ]),
  passive1: ct.talentTem('passive1', [
    charConditionalDocument(key, cond.a1AfterBurst, {
      teamBuff: true,
  ...
  constellation6: ct.talentTem('constellation6', [
    charConditionalDocument(key, cond.c6AfterThrust, {
