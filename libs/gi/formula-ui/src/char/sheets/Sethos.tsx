...
const formula = formulas.Sethos
const cond = conditionals.Sethos
...
const sheet: UISheet<TalentSheetElementKey> = {
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          fieldRef: formula.charged_shadow.tag,
        },
      ],
    },
  ]),
  ...
  passive2: ct.talentTem('passive2', [
    charConditionalDocument(key, cond.a4Sandshade),
  ]),
  ...
  constellation4: ct.talentTem('constellation4', [
    charConditionalDocument(key, cond.c4Strike, { teamBuff: true }),
  ]),
