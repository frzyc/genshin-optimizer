...
const formula = formulas.Escoffier
const cond = conditionals.Escoffier
...
const sheet: UISheet<TalentSheetElementKey> = {
  ...
  passive1: ct.talentTem('passive1', [
    {
      ...
      fields: [
        {
          title: ct.chg('passive1.skillParams.0'),
  ...
  passive2: ct.talentTem('passive2', [
    charConditionalDocument(key, cond.a4SkillBurstHit, { teamBuff: true }),
  ]),
  passive3: ct.talentTem('passive3'),
  constellation1: ct.talentTem('constellation1', [
    charConditionalDocument(key, cond.c1AfterSkillBurst, { teamBuff: true }),
  ]),
