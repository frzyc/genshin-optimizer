...
const formula = formulas.Freminet
const cond = conditionals.Freminet
...
const sheet: UISheet<TalentSheetElementKey> = {
  ...
  burst: ct.talentTem('burst', [
    ...
    charConditionalDocument(key, cond.stalk),
  ]),
  passive1: ct.talentTem('passive1'),
  passive2: ct.talentTem('passive2', [
    charConditionalDocument(key, cond.a4AfterShatter, {
      fields: [
        {
          title: st('skillCDRed'),
          fieldValue: '',
  ...
  constellation4: ct.talentTem('constellation4', [
    charConditionalDocument(key, cond.c4C6Stacks),
  ]),
