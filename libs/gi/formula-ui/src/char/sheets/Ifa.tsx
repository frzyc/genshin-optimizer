...
const formula = formulas.Ifa
const cond = conditionals.Ifa
...
const sheet: UISheet<TalentSheetElementKey> = {
      ...
      fields: [
        {
          ...
          fieldRef: formula.skill_tonicDmg.tag,
        },
        {
          title: ct.chg('skill.skillParams.1'),
          fieldRef: formula.skill_tonicHeal.tag,
        },
        {
  ...
  passive1: ct.talentTem('passive1', [
    charConditionalDocument(key, cond.a1Essentials, {
      teamBuff: true,
      label: ct.ch('a1Cond'),
    }),
  ]),
