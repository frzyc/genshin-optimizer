...
const formula = formulas.Lyney
const cond = conditionals.Lyney
...
const sheet: UISheet<TalentSheetElementKey> = {
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          fieldRef: formula.charged_prop.tag,
        },
        {
          title: ct.chg('auto.skillParams.9'),
          fieldRef: formula.charged_hpCost.tag,
        },
      ],
    },
    {
  ...
  passive1: ct.talentTem('passive1', [
    charConditionalDocument(key, cond.a1DrainHp, {
      fields: [
        {
  ...
  passive2: ct.talentTem('passive2', [
    charConditionalDocument(key, cond.a4AffectedByPyro),
  ]),
  ...
  constellation4: ct.talentTem('constellation4', [
    charConditionalDocument(key, cond.c4Hit, {
      fields: [
        {
          title: stg('duration'),
          fieldValue: '',
