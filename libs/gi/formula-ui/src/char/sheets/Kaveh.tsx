...
const formula = formulas.Kaveh
const cond = conditionals.Kaveh
...
const sheet: UISheet<TalentSheetElementKey> = {
  ...
  passive2: ct.talentTem('passive2', [
    charConditionalDocument(key, cond.a4Stacks, { teamBuff: true }),
  ]),
  passive3: ct.talentTem('passive3'),
  constellation1: ct.talentTem('constellation1', [
    charConditionalDocument(key, cond.c1AfterSkill),
  ]),
