import { BootstrapTooltip } from '@genshin-optimizer/common_ui'
import { translate, type CalcMeta } from '@genshin-optimizer/gi_formula'
import type { CalcResult } from '@genshin-optimizer/pando_engine'
