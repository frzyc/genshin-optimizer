...
export function dataObjForCharacterSheet(
  ...
  if (element) {
    ...
    if (additional[0]?.flags?.moonsign === undefined) {
  ...
  data.teamBuff!.tally!.hexerei = additional[0]?.flags?.hexerei
  data.teamBuff!.tally!.moonsign = additional[0]?.flags?.moonsign
...
const nicoleHex = findNicoleData((data) => data.flags.hexerei, 0)
