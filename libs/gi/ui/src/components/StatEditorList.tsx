...
const inputPremodKeyToGroupMap: Record<InputPremodKey, GroupKey> = {
  ...
  lunarcrystallize_baseDmg_: 'reaction_dmg_bonus',
  lunarcrystallize_specialDmg_: 'reaction_dmg_bonus',
  lunarcrystallize_dmg_: 'reaction_dmg_bonus',
  stellarconduct_baseDmg_: 'reaction_dmg_bonus',
  stellarconduct_specialDmg_: 'reaction_dmg_bonus',
  stellarconduct_dmg_: 'reaction_dmg_bonus',
  stellarconduct_mult_: 'reaction_dmg_bonus',
  stellarswirl_baseDmg_: 'reaction_dmg_bonus',
  stellarswirl_specialDmg_: 'reaction_dmg_bonus',
  stellarswirl_dmg_: 'reaction_dmg_bonus',
  stellarswirl_mult_: 'reaction_dmg_bonus',
  ...
  lunarcharged_critRate_: 'reaction_crit',
  lunarcharged_critDMG_: 'reaction_crit',
  lunarcharged_dmgInc: 'elem_dmgInc',
  lunarcharged_directDmgInc: 'elem_dmgInc',
  lunarcharged_reactionDmgInc: 'elem_dmgInc',
  ...
  lunarbloom_directDmgInc: 'elem_dmgInc',
  lunarbloom_reactionDmgInc: 'elem_dmgInc',
  lunarcrystallize_critRate_: 'reaction_crit',
  lunarcrystallize_critDMG_: 'reaction_crit',
  lunarcrystallize_dmgInc: 'elem_dmgInc',
  lunarcrystallize_directDmgInc: 'elem_dmgInc',
  lunarcrystallize_reactionDmgInc: 'elem_dmgInc',
  stellarconduct_critRate_: 'reaction_crit',
  stellarconduct_critDMG_: 'reaction_crit',
  stellarconduct_dmgInc: 'elem_dmgInc',
  stellarconduct_directDmgInc: 'elem_dmgInc',
  stellarconduct_reactionDmgInc: 'elem_dmgInc',
  stellarswirl_critRate_: 'reaction_crit',
  stellarswirl_critDMG_: 'reaction_crit',
  stellarswirl_dmgInc: 'elem_dmgInc',
  stellarswirl_directDmgInc: 'elem_dmgInc',
  stellarswirl_reactionDmgInc: 'elem_dmgInc',
