...
const team = [
  ...
  },
  {
    name: '✦ Sin ✦',
    img: sin,
    title: (t: TFunction) => t('teamCard.jobTitle.admin'),
    subtitle: 'Ohh, shiny.',
    url: '',
  },
  {
  ...
  },
  {
    name: 'Polomo',
    img: polomo,
    title: (t: TFunction) => t('teamCard.jobTitle.translator'),
  ...
  },
  {
    name: 'Vlad',
    img: vlad,
    title: (t: TFunction) => t('teamCard.jobTitle.TC'),
  ...
  },
  {
    name: 'D1firehail',
    img: d1,
    title: (t: TFunction) => t('teamCard.jobTitle.mod'),
