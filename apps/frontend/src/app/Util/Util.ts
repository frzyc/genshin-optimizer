...
/**
 * @deprecated use the @genshin-optimizer/common_util `objMap` function.
 * @param obj
 * @param fn
 */
...
/**
 * @deprecated use the @genshin-optimizer/common_util `rangeGen` function.
 * @param from
 * @param to
 */
 ...
 * @deprecated use the @genshin-optimizer/common_util `range` function.
 * @param from
 * @param to
 */
 ...
 * @deprecated use the @genshin-optimizer/common_util `cartesian` function.
 * @param q
 * @returns
 */
