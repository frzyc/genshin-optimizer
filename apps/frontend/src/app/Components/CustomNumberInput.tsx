...
/**
 * @deprecated use `StyledInputBase` in `@genshin-optimizer/common_ui`
 */
...
/**
 * @deprecated use `CustomNumberInputButtonGroupWrapper` in `@genshin-optimizer/common_ui`
 */
...
/**
 * @deprecated use `CustomNumberInput` in `@genshin-optimizer/common_ui`
 */
