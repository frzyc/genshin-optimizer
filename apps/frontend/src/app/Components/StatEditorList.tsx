...
function StatFilterItem({ statKey, statKeyOptions = [], value = 0, delKey, setKey, setValue, disabled = false, getOptionDisabled }: {
  ...
  const onKeyChange = useCallback((newKey: InputPremodKey | null) => {
    if (newKey) {
