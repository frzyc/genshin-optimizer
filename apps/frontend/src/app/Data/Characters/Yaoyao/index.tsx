...
const adeptalLegacy_dendro_res_ = equal(condAdeptalLegacy, "on", dm.burst.dendro_res_)
...
const [condC4AfterSkillBurstPath, condC4AfterSkillBurst] = cond(key, "c4AfterSkillBurst")
const c4AfterSkillBurst_eleMas = greaterEq(input.constellation, 4,
...
const dmgFormulas = {
  ...
  burst: {
    ...
    radishHeal: healNodeTalent("hp", dm.burst.radish_heal_hp, dm.burst.radish_heal_flat, "burst"),
  },
  passive2: {
  ...
  talent: {
    ...
    skill: ct.talentTem("skill", [{
      fields: [{
        ...
        node: infoMut(dmgFormulas.skill.heal, { name: ct.chg(`skill.skillParams.1`) }),
      }, {
