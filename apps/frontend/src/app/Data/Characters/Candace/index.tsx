...
const dmgFormulas = {
  ...
  constellation6: {
    dmg: greaterEq(
      input.constellation,
      6,
      customDmgNode(prod(percent(dm.constellation6.dmg), input.total.hp), 'burst')
    ),
  },
}
    ...
    skill: ct.talentTem('skill', [
      {
        fields: [
          ...
          {
            node: infoMut(dmgFormulas.skill.hydroShield, {
    ...
    burst: ct.talentTem('burst', [
      {
        fields: [
          ...
          {
            node: infoMut(dmgFormulas.burst.waveDmg, {
                ...
                value: (data) =>
                  data.get(input.constellation).value >= 1
                    ? `${dm.burst.duration}s + ${
                      ...
                      }s = ${dm.burst.duration + dm.constellation1.durationInc}`
                    : dm.burst.duration,
                unit: 's',
              },
            ],
