...
const time_normal_dmg_ = equal(
  input.weapon.key,
  key,
  lookup(
    condTimePassive,
    Object.fromEntries(
      time_normal_dmg_stacksArr.map((time) => [
        time,
        prod(
          time,
...
const hit_normal_dmg_ = equal(
  input.weapon.key,
  key,
  lookup(
    condHitPassive,
    Object.fromEntries(
      hit_normal_dmg_stacksArr.map((hit) => [
        hit,
        prod(
          hit,
  ...
  document: [
    ...
    },
    {
      ...
      states: Object.fromEntries(
        time_normal_dmg_stacksArr.map((i) => [
          i,
          {
    ...
    },
    {
      ...
      states: Object.fromEntries(
        hit_normal_dmg_stacksArr.map((i) => [
          i,
          {
