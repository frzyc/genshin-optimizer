...
const mergeDuplicateNodes = testing.mergeDuplicateNodes
...
describe('optimization', () => {
  ...
  test('complex formula invariant', () => {
    ...
    const seq1 = [cf, flatten, cf, mergeDuplicateNodes]
    const seq2 = [mergeDuplicateNodes, cf, flatten, mergeDuplicateNodes, cf]
  ...
  test('normal form & deduplicate identical terms', () => {
    ...
    const dedup = mergeDuplicateNodes([sum(f1, f2)])[0]
