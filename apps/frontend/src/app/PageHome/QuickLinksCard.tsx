...
const buttons = [{
  ...
  icon: <DiscordIcon />,
  tooltip: t => "",
  url: import.meta.env.NX_URL_DISCORD_GO,
  color: "discord",
}, {
  title: () => "Genshin Optimizer Github",
  icon: <GitHub />,
  tooltip: t => "",
  url: import.meta.env.NX_URL_GITHUB_GO,
  color: "white",
}, {
  title: t => t`quickLinksCard.buttons.patchNotes.title`,
  icon: <Description />,
  tooltip: t => t`quickLinksCard.buttons.patchNotes.tooltip`,
  url: `${import.meta.env.NX_URL_GITHUB_GO}/releases`,
  color: "secondary",
}, {
  title: t => t`quickLinksCard.buttons.tyGuide.title`,
  icon: <YouTube />,
  tooltip: t => t`quickLinksCard.buttons.tyGuide.tooltip`,
  url: import.meta.env.NX_URL_YOUTUBE_TUTPL,
  color: "red",
}, {
  title: () => "Twitch (frzyc)",
  icon: <TwitchIcon />,
  tooltip: t => "",
  url: import.meta.env.NX_URL_TWITCH_FRZYC,
  color: "twitch",
}, {
  title: () => "Twitter (frzyc)",
  icon: <Twitter />,
  tooltip: t => "",
  url: import.meta.env.NX_URL_TWITTER_FRZYC,
  color: "twitter",
}, {
  title: () => "Patreon (frzyc)",
  icon: <PatreonIcon />,
  tooltip: t => "",
  url: import.meta.env.NX_URL_PATREON_FRZYC,
  color: "patreon",
}, {
  title: () => "PayPal (frzyc)",
  icon: <PaypalIcon />,
  tooltip: t => "",
  url: import.meta.env.NX_URL_PAYPAL_FRZYC,
  color: "paypal",
}, {
