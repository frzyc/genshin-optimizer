...
import { CalcContext, CalcContextObj } from '../../Context/CalcContext'
import { read } from '@genshin-optimizer/waverider'
...
function HeaderContent() {
  ...
  const characterEle = calc.compute(member0.char.ele).val as unknown as ElementKey
