...
export const data = dataObjForWeaponSheet("EverlastingMoonglow", "catalyst",
  [
    { stat: data_gen.mainStat.type as any, offset: data_gen.mainStat.base, lvlCurve: data_gen.mainStat.curve },
    { stat: data_gen.subStat!.type as any, offset: data_gen.subStat!.base, lvlCurve: data_gen.subStat!.curve, },
    { stat: "heal_", refinement: data_gen.addProps.map(x => x.heal_) as any },
    { stat: "atk", asc: data_gen.ascension.map(x => x.addStats.atk ?? 0) },
  ],
  {
    dmgBonus: {
