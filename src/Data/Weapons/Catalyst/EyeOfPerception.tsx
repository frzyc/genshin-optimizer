...
const weapon : WeaponSheet = {
  ...
  rarity: 4,
  passiveName: "Echo",
  passiveDescription: stats => <span>Normal and Charged Attacks have a 50% chance to fire a Bolt of Perception, dealing {refinementVals[stats.weapon.refineIndex]}% ATK{DisplayPercent(refinementVals[stats.weapon.refineIndex], stats, getTalentStatKey("physical", stats))} as DMG. This bolt can bounce between opponents a maximum of 4 times. This effect can occur once every {refinementCdVals[stats.weapon.refineIndex]}s.</span>,
