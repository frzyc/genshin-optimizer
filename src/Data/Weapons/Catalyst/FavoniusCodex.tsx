...
const weapon : WeaponSheet = {
  ...
  passiveDescription: stats => `CRIT hits have a ${refinementVals[stats.weapon.refineIndex]}% chance to generate a small amount of Elemental Particles, which will regenerate 6 Energy for the character. Can only occur once every ${refinementCdVals[stats.weapon.refineIndex]}s.`,
