...
const weapon: IWeaponSheet = {
  ...
  passiveDescription: stats => <span>Charged Attack hits on weak points deal an additional {refinementVals[stats.weapon.refineIndex]}% ATK DMG as CRIT DMG{DisplayPercent(refinementVals[stats.weapon.refineIndex], stats, "physical_critHit")}. Can only occur once every 10s.</span>,
