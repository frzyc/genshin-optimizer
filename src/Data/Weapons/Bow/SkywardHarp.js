...
const weapon = {
  ...
  passiveDescription: (refineIndex, charFinalStats, c) => <span>Increases CRIT DMG by {refinementVals[refineIndex]}%. Hits have a {refinementChangeVals[refineIndex]}% chance to inflict a small AoE attack, dealing 125% <span className="text-physical">Physical ATK DMG</span>{DisplayPercent(125, charFinalStats, getTalentStatKey("physical", charFinalStats))}. Can only occur once every 4s.</span>,//$
