...
const normal_dmg_ = subscript(input.weapon.refineIndex, autoDmgInc, KeyMap.keyToInfo("normal_dmg_"))
const charged_dmg_ = subscript(input.weapon.refineIndex, autoDmgInc, KeyMap.keyToInfo("charged_dmg_"))
...
}, naught, KeyMap.keyToInfo("normal_dmg_"))
const charged_dmg_arrow_ = lookup(condPassive, {
  ...objectKeyMap(range(1, 5), i => prod(dmgInc, i)),
}, naught, KeyMap.keyToInfo("charged_dmg_"))
