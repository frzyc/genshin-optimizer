...
const weapon = {
  ...
  passiveDescription: (refineIndex, charFinalStats) => <span>Upon hit, Normal and Aimed Shot Attacks have a 50% chance to generate a Cyclone, which will continuously attract surrounding enemies, dealing {refinementVals[refineIndex]}% of ATK{WeaponPercent(refinementVals[refineIndex], charFinalStats.atk)} as DMG to these enemies every 0.5s for 4s. This effect can only occur once every {refinementCdVals[refineIndex]}s.</span>,//$
