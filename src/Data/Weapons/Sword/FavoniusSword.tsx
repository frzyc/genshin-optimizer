...
const weapon : WeaponSheet = {
  ...
  passiveDescription: stats => `60% chance to generate a small amount of Elemental Particles, which will regenerate 6 Energy for the character. Can only occur once every ${refinementVals[stats.weapon.refineIndex]}s`,
