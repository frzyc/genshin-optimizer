...
const weapon = {
  ...
  rarity: 4,
  passiveName: "Justice",
  passiveDescription: (refineIndex, charFinalStats) => <span>Increases DMG dealt by Normal and Charged Attacks by {refinementVals[refineIndex]}%. Additionally, regenerates {refinementRegenVals[refineIndex]}% of ATK{WeaponPercent(refinementRegenVals[refineIndex], charFinalStats.atk)} as HP when Normal and Charged Attacks score a CRIT Hit. This effect can occur once every 5s.</span>,
