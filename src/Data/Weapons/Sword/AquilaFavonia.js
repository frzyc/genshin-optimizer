...
const weapon = {
  ...
  passiveDescription: (refineIndex, charFinalStats) => <span>ATK is increased by {refinementVals[refineIndex]}%. Triggers on taking DMG: the soul of the Falcon of the West awakens, holding the banner of resistance aloft, regenerating HP equal to {refinementRegenVals[refineIndex]}% of ATK{WeaponPercent(refinementRegenVals[refineIndex], charFinalStats.atk)} and dealing {refinementDmgVals[refineIndex]}% of ATK{WeaponPercent(refinementDmgVals[refineIndex], charFinalStats.atk)} as DMG to surrounding opponents. This effect can only occur once every 15s.</span>,
