...
const weapon = {
  ...
  rarity: 3,
  passiveName: "Gash",
  passiveDescription: (refineIndex, charFinalStats, c) => <span>On hit, has a 50% chance to deal {refinementVals[refineIndex]}% ATK DMG{DisplayPercent(refinementVals[refineIndex], charFinalStats, Character.getTalentStatKey("physical", c))} to a single opponent. Can only occur once every {refinementcdVals[refineIndex]}s.</span>,
