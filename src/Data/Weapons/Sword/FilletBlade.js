...
const weapon = {
  ...
  rarity: 3,
  passiveName: "Gash",
  passiveDescription: (refineIndex, charFinalStats) => <span>On hit, has a 50% chance to deal {refinementVals[refineIndex]}% ATK DMG{WeaponPercent(refinementVals[refineIndex], charFinalStats.atk)} to a single opponent. Can only occur once every {refinementcdVals[refineIndex]}s.</span>,
