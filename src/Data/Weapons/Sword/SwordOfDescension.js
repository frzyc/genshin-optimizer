...
const weapon = {
  ...
  passiveDescription: (refineIndex, charFinalStats) => <span>Hitting opponents with Normal and Charged Attacks grants a 50% chance to deal 200% ATK as DMG{WeaponPercent(200, charFinalStats.atk)} in a small AoE. This effect can only occur once every 10s. Additionally, if the Traveler equips the Sword of Descension, their ATK is increased by 66.</span>,
