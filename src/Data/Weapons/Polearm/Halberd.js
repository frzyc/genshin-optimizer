...
const weapon = {
  ...
  rarity: 3,
  passiveName: "Heavy",
  passiveDescription: (refineIndex, charFinalStats, c) => <span>Normal Attacks deal an additional {refinementVals[refineIndex]}% ATK{DisplayPercent(refinementVals[refineIndex], charFinalStats, Character.getTalentStatKey("physical", c))} as DMG. Can only occur once every 10s.</span>,
