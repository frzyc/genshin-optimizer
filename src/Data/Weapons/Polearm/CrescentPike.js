...
const weapon = {
  ...
  passiveDescription: (refineIndex, charFinalStats) => <span>After picking up an Elemental Orb/Particle, Normal and Charged Attacks deal an additional {refinementVals[refineIndex]}% ATK DMG{WeaponPercent(refinementVals[refineIndex], charFinalStats.atk)} for 5s.</span>,
