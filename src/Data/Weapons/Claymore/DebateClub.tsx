...
const weapon: IWeaponSheet = {
  ...
  passiveDescription: stats => <span>After using an Elemental Skill, Normal or Charged Attacks, on hit, deal an additional {refinementVals[stats.weapon.refineIndex]}% ATK DMG{DisplayPercent(refinementVals[stats.weapon.refineIndex], stats, getTalentStatKey("physical", stats))} in a small area. Effect lasts 15s. DMG can only occur once every 3s.</span>,
