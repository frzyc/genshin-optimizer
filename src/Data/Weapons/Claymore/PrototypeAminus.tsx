...
const weapon : WeaponSheet = {
  ...
  rarity: 4,
  passiveName: "Crush",
  passiveDescription: stats => <span>On hit, Normal or Charged Attacks have a 50% chance to deal an additional {refinementVals[stats.weapon.refineIndex]}% ATK DMG{DisplayPercent(refinementVals[stats.weapon.refineIndex], stats, getTalentStatKey("physical", stats))} to opponents within a small AoE. Can only occur once every 15s.</span>,
