...
const normal_dmg_ = prod(subscript(input.weapon.refineIndex, normal_dmg_Src, { key: "_" }), input.premod.def)
const charged_dmg_ = prod(subscript(input.weapon.refineIndex, charged_dmg_Src, { key: "_" }), input.premod.def)
