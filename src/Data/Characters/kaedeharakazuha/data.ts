...
export const data = {
  baseStat: {
    characterHP: [1039, 2695, 3586, 5366, 5999, 6902, 7747, 8659, 9292, 10213, 10846, 11777, 12410, 13348],
    characterATK: [23, 60, 80, 119, 133, 153, 172, 192, 206, 227, 241, 262, 276, 297],
    characterDEF: [63, 163, 217, 324, 363, 417, 468, 523, 562, 617, 656, 712, 750, 807]
  },
  specializeStat: {
    key: "eleMas",
    value: [0, 0, 0, 0, 28.8, 28.8, 57.6, 57.6, 57.6, 57.6, 86.4, 86.4, 115.2, 115.2]
  },
  normal: {
    hitArr: [
