...
const sheet: ICharacterSheet = {
  ...
  talent: {  auto: ct.talentTemplate("auto", [{
      ...
      skill: ct.talentTemplate("skill", [{
        ...
        value: condC1,
        path: condC1Path,
        name: ct.trm("c1CondName"),
        states: {
          on: {
            fields: [{
              text: ct.trm("c1PullSpeed")
            }, {
              node: skill_dmg_
            }]
          }
      ...
      burst: ct.talentTemplate("burst", [{
        fields: [{
          ...
          node: infoMut(dmgFormulas.burst.enterExitDmg, { name: ct.tr(`burst.skillParams.1`) }),
        }, {
          node: infoMut(dmgFormulas.burst.regen, { name: ct.tr(`burst.skillParams.2`) }),
        }, {
          node: infoMut(dmgFormulas.burst.contRegen, { name: ct.tr(`burst.skillParams.3`) }),
        }, {
          text: sgt("duration"),
          value: 11,
          unit: "s"
        ...
        states: {
          on: {
            fields: [{
              node: infoMut(dmgRed_disp, KeyMap.keyToInfo("dmgRed_"))
            }]
          }
        }
      })]),
      ...
      passive1: ct.talentTemplate("passive1", [ct.fieldsTemplate("passive1", {
        fields: [{
          node: infoMut(dmgFormulas.passive1.a1Regen, { name: sgt(`healing`) }),
        }]
      })]),
