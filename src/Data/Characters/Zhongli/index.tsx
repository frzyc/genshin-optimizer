...
const sheet: ICharacterSheet = {
  ...
  talent: {
    ...
    skill: ct.talentTemplate("skill", [{
      fields: [{
        node: infoMut(dmgFormulas.skill.stele, { name: ct.tr("skill.stele") })
      }, {
        node: infoMut(dmgFormulas.skill.resonance, { name: ct.tr("skill.resonance") })
      }, {
        text: ct.trm("skill.maxStele"),
        ...
        node: infoMut(dmgFormulas.skill.holdDMG, { name: ct.tr(`skill.skillParams.2`) })
      }, {
        text: st("holdCD"),
        value: datamine.skill.holdCD,
        unit: "s"
      }, {
        node: infoMut(dmgFormulas.skill.shield, { name: sgt(`dmgAbsorption`) })
      }, {
    ...
    constellation6: ct.talentTemplate("constellation6", [ct.fieldsTemplate("constellation6", {
      fields: [{
        node: infoMut(dmgFormulas.constellation6.heal, { name: ct.tr("c6heal") })
      }]
    })]),
  },
}
