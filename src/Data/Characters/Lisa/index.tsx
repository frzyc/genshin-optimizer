...
const char: ICharacterSheet = {
  ...
  talent: {
    ...
    passive1: {
      ...
      img: passive1,
      document: [{ text: <span>Hits by Charged Attacks apply <b>Violet Arc's Conductive</b> status to opponents.</span> }],
    },
    passive2: {
    ...
    constellation1: {
      ...
      img: c1,
      document: [{ text: <span>Lisa regenerates 2 Energy for every opponent hit while holding <b>Violet Arc</b>. A maximum of 10 Energy can be regenerated in this manner at any one time.</span> }],
    },
    constellation2: {
    ...
    constellation6: {
      ...
      img: c6,
      document: [{ text: <span>When Lisa takes the field, she applies 3 stacks of <b>Violet Arc's Conductive</b> status onto nearby opponents. This effect can only occur once every 5s.</span> }],
    }
  },
};
export default char;
