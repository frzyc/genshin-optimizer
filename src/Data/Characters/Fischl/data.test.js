...
const url = "https://frzyc.github.io/genshin-optimizer/#/flex?v=1&d=5p5001045j03g04L07g0c5g03142L08K19r0a04u4g04245u0aI08L09h1a5g0g347B08E1aR14F0p5k09441d48R14035j08006004L60A02550004Rust3L70010100"
    ...
    describe("Ruin Guard level 85", () => {
      ...
      describe("no crit", () => {
        ...
        test("hit", () => {
          ...
          expect(formula.constellation1.jointAttDmg(stats)[0](stats)).toApproximate(61)
          expect(formula.skill.activeChar(stats)[0](stats)).toApproximate(277)

          expect(formula.passive2.thunderRetri(stats)[0](stats)).toApproximate(740)
      ...
      describe("crit", () => {
        ...
        test("hit", () => {
          ...
          expect(formula.constellation1.jointAttDmg(stats)[0](stats)).toApproximate(118)
    ...
    describe("Ruin Guard level 91", () => {
      ...
      describe("no crit", () => {
        ...
        test("hit", () => {
          ...
          expect(formula.constellation1.jointAttDmg(stats)[0](stats)).toApproximate(60)
          expect(formula.skill.activeChar(stats)[0](stats)).toApproximate(272)

          expect(formula.passive2.thunderRetri(stats)[0](stats)).toApproximate(727)
      ...
      describe("crit", () => {
        ...
        test("hit", () => {
          ...
          expect(formula.constellation1.jointAttDmg(stats)[0](stats)).toApproximate(116)
          expect(formula.skill.activeChar(stats)[0](stats)).toApproximate(522)

          expect(formula.passive2.thunderRetri(stats)[0](stats)).toApproximate(1394)
