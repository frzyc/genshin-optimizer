...
const sheet: ICharacterSheet = {
  ...
  talent: {  auto: ct.talentTemplate("auto", [{
        ...
        fields: [{
          node: infoMut(dmgFormulas.charged.dmg, { name: ct.tr(`auto.skillParams.3`) }),
        }, {
      ...
      skill: ct.talentTemplate("skill", [{
        fields: [{
          node: infoMut(dmgFormulas.skill.dmg1, { name: ct.tr(`skill.skillParams.0`) }),
        }, {
          node: infoMut(dmgFormulas.skill.dmg2, { name: ct.tr(`skill.skillParams.1`) }),
        }, {
          node: infoMut(dmgFormulas.skill.dmg3, { name: ct.tr(`skill.skillParams.2`) }),
        }, {
          node: infoMut(dmgFormulas.skill.dmg4, { name: ct.tr(`skill.skillParams.3`) }),
        }, {
      ...
      burst: ct.talentTemplate("burst", [{
        fields: [{
          ...
          node: infoMut(dmgFormulas.burst.tenkoDmg, { name: ct.tr(`burst.skillParams.1`) }),
        }, {
