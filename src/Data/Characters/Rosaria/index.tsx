...
const sheet: ICharacterSheet = {
  ...
  talent: {
    ...
    skill: ct.talentTemplate("skill", [{
      fields: [{
        node: infoMut(dmgFormulas.skill.hit1, { name: ct.tr(`skill.skillParams.0`) }),
        textSuffix: "(1)"
      }, {
        node: infoMut(dmgFormulas.skill.hit2, { name: ct.tr(`skill.skillParams.0`) }),
        textSuffix: "(2)"
      }, {
    ...
    burst: ct.talentTemplate("burst", [{
      fields: [{
        node: infoMut(dmgFormulas.burst.hit1, { name: ct.tr(`burst.skillParams.0`) }),
        textSuffix: "(1)"
      }, {
        node: infoMut(dmgFormulas.burst.hit2, { name: ct.tr(`burst.skillParams.0`) }),
        textSuffix: "(2)"
      }, {
    ...
    passive2: ct.talentTemplate("passive2", [ct.conditionalTemplate("passive2", {
      ...
      states: {
        on: {
          fields: [{
            node: infoMut(nodeA4CritBonusDisp, { ...KeyMap.keyToInfo("critRate_"), isTeamBuff: true }),
          }, {
            text: sgt("duration"),
