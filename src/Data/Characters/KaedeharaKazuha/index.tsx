...
const dmgFormulas = {
  ...
  burst: {
    ...
    ...Object.fromEntries(absorbableEle.map(key =>
      [key, equal(condBurstAbsorption, key, dmgNode("atk", dm.burst.add, "burst", { hit: { ele: constant(key) } }))]))
  },
  passive1: Object.fromEntries(absorbableEle.map(key =>
    [key, equal(condSkillAbsorption, key, customDmgNode(prod(input.total.atk, dm.passive1.asorbAdd), "plunging", { hit: { ele: constant(key) } }))])),
  passive2: asc4,
  constellation6: {
