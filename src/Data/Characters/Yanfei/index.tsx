...
const char: ICharacterSheet = {
  ...
  talent: {
    ...
    constellation1: {
      ...
      img: c1,
      document: [{ text: <span>When Yanfei uses her Charged Attacks, each existing <b>Scarlet Seal</b> additionally reduces the stamina cost of this Charged Attack by 10% and increases resistance against interruption during its release.</span> }],
    },
    constellation2: {
    ...
    constellation3: {
      ...
      img: c3,
      document: [{ text: <span>Increases the level of <b>Signed Edict</b> by 3. Maximum upgrade level is 15.</span> }],
      stats: { skillBoost: 3 }
    },
    constellation4: {
    ...
    constellation5: {
      ...
      img: c5,
      document: [{ text: <span>Increases the level of <b>Done Deal</b> by 3. Maximum upgrade level is 15.</span> }],
      stats: { burstBoost: 3 }
    },
    constellation6: {
      name: "Extra Clause",
      img: c6,
      document: [{ text: <span>Increases the maximum number of <b>Scarlet Seals</b> by 1.</span> }],
    }
  },
};
export default char;
