...
import { constant, data, infoMut, lookup, one, percent, prod, stringPrio, subscript, sum, unequalStr } from "../../Formula/utils";
...
export const infusionNode = stringPrio(
  ...
  unequalStr(input.infusion.team, constant("noInfusion"), input.infusion.team),
