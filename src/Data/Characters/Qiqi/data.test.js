  ...
  describe("with artifacts", () => {
    ...
    describe("no crit", () => {
      ...
      test("hits", () => {
        ...
        expect(formula.charged.hit(stats)[0](stats)).toApproximate(201)
    ...
    describe("crit", () => {
      ...
      test("hits", () => {
        ...
        expect(formula.charged.hit(stats)[0](stats)).toApproximate(345)
  ...
  describe("with artifacts", () => {
    ...
    describe("no crit", () => {
      ...
      test("hits", () => {
        ...
        expect(formula.charged.hit(stats)[0](stats)).toApproximate(203)
    ...
    describe("crit", () => {
      ...
      test("hits", () => {
        ...
        expect(formula.charged.hit(stats)[0](stats)).toApproximate(436)
    ...
    describe("C2", () => {
      ...
      describe("no crit", () => {
        ...
        test("hits", () => {
          ...
          expect(formula.charged.hit(stats)[0](stats)).toApproximate(233)
          expect(formula.skill.hit(stats)[0](stats)).toApproximate(1285)
          expect(formula.skill.herald(stats)[0](stats)).toApproximate(482)
        })
      })
      ...
      describe("crit", () => {
        ...
        test("hits", () => {
          ...
          expect(formula.charged.hit(stats)[0](stats)).toApproximate(501)
          expect(formula.skill.hit(stats)[0](stats)).toApproximate(2757)
          expect(formula.skill.herald(stats)[0](stats)).toApproximate(1034)
