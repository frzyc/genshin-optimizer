...
const char = {
  ...
  talent: {
      ...
      document: [
        {
          text: (
            <span>
              ...
              <ul className="mb-2">
                <li>
                  On hit, Qiqi's Normal and Charged Attacks regenerate HP for
                  your own party members and nearby teammates. Healing scales
                  based on Qiqi's ATK.
                </li>
          ...
          fields: [
            ...
            },
            {
              ...
              formulaText: (tlvl, stats) => (
                <span>
                  {data.skill.hitregen.atk[tlvl]}% {Stat.printStat("characterAtk", stats)} + {data.skill.hitregen.base[tlvl]} * {Stat.printStat("heal_multi", stats)}
                </span>
              ),
            ...
            },
            {
              ...
              formulaText: (tlvl, stats) => (
                <span>
                  {data.skill.continuousregen.atk[tlvl]}% {Stat.printStat("characterAtk", stats)} + {data.skill.continuousregen.base[tlvl]} * {Stat.printStat("heal_multi", stats)}
                </span>
              ),
            ...
            },
            {
              ...
              formulaText: (tlvl, stats) => (
                <span>
                  {data.skill.herald[tlvl]}% {Stat.printStat(getTalentStatKey("skill", stats), stats)}
                </span>
              ),
      ...
      document: [
        {
          ...
          fields: [
            ...
            },
            {
              ...
              formulaText: (tlvl, stats) => (
                <span>
                  {data.burst.healing.atk[tlvl]}% {Stat.printStat("characterAtk", stats)} + {data.burst.healing.base} * {Stat.printStat("heal_multi", stats)}
                </span>
              ),
      ...
      document: [
        {
          text: (
            <span>
              ...
              has a 50% chance to apply a Fortune-Preserving Talisman to them
              for 6s. This effect can only occur once every 30s.
            </span>
          ),
          fields: [{
    ...
    constellation5: {
      ...
      img: c5,
      document: [{
        text: (<span>Increases the Level of Adeptus Art: Herald of Frost by 3. Maximum upgrade level is 15.</span>),
      }],
      talentBoost: { skill: 3 },
    },
    constellation6: {
