...
export const data = {
  ...
  normal: {
    hitArr: [
      ...
      [26.06,28.18,30.3,33.33,35.45,37.87,41.21,44.54,47.87,51.51,55.68,60.58,65.48,70.37,75.72],//3.1
      [26.06,28.18,30.3,33.33,35.45,37.87,41.21,44.54,47.87,51.51,55.68,60.58,65.48,70.37,75.72],//3.2
      [14.1,15.25,16.4,18.04,19.19,20.5,22.3,24.11,25.91,27.88,30.14,32.79,35.44,38.09,40.98],//*4
...
const formula = {
  ...
  [i, (tlvl, stats) => basicDMGFormula((i == 4 ? 4 : 1) * (arr[tlvl]), stats,"normal")])),
