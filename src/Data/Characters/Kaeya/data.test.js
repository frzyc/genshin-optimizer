  ...
  describe("with artifacts", () => {
    ...
    describe("no crit", () => {
      ...
      test("hit", () => {
        ...
        expect(formula.charged.atk1(stats)[0](stats)).toApproximate(56)
        expect(formula.charged.atk2(stats)[0](stats)).toApproximate(74)
        ...
        expect(formula.passive1.heal(stats)[0](stats)).toApproximate(95)
    ...
    describe("crit", () => {
      ...
      test("hit", () => {
        ...
        expect(formula.charged.atk1(stats)[0](stats)).toApproximate(129)
        expect(formula.charged.atk2(stats)[0](stats)).toApproximate(171)
