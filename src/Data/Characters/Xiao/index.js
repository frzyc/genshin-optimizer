  ...
  talent: {
    auto: {
      ...
      document: [{
        ...
        ({
          text: `${i + 1}-Hit DMG`,
          formulaText: (tlvl, stats, c) => <span>{percentArr[tlvl]}%{(i === 0 || i === 3) ? " × 2" : ""} {Stat.printStat(Character.getTalentStatKey("normal", c), stats)}</span>,
          formula: (tlvl, stats, c) => (percentArr[tlvl] / 100) * ((i === 0 || i === 3) ? 2 : 1) * stats[Character.getTalentStatKey("normal", c)],
