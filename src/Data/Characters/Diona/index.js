...
const char = {
  ...
  talent: {
    ...
    passive2: {
      ...
      img: passive2,
      document: [{ text: <span>Opponents who enter the AoE of Signature Mix have 10% decreased ATK for 15s.</span> }],//TODO: enemy atk decrease
    },
    passive3: {
    ...
    constellation2: {
      ...
      img: c2,
      document: [{ text: <span>Increases Icy Paws' DMG by 15%, and increases its shield's DMG Absorption by 15%. Additionally, when paws hit their targets, creates a shield for other nearby characters on the field with 50% of the Icy Paws shield's DMG Absorption for 5s.</span> }],
