...
const url = "https://frzyc.github.io/genshin-optimizer/#/flex?v=1&d=4a5k03146R15g09F1aX2a5k04245W02t13g0aY1q5k0i341Y74F1691aa3a5k09446b25K02F17B0m000004L80A000004echaracterLevel281ccharacterATK3283ccharacterDEF3763bcharacterHP51227404Rust2L1010100"
  ...
  describe("with artifacts", () => {
    ...
    describe('no crit', () => {
      ...
      test("hit", () => {
        ...
        expect(formula.charged.aimedShot(stats)[0](stats)).toApproximate(80)
        expect(formula.charged.fullAimedShot(stats)[0](stats)).toApproximate(1293)
    ...
    describe('crit', () => {
      ...
      test("hit", () => {
        ...
        expect(formula.charged.aimedShot(stats)[0](stats)).toApproximate(161)
        expect(formula.charged.fullAimedShot(stats)[0](stats)).toApproximate(2602)
