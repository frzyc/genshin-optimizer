...
describe("Testing CustomFormControl Component", () => {
  ...
  describe('Basic Interactions, Int', () => {
    beforeEach(() => {
      displayValue = null
      utils = render(<CustomFormControl placeholder={undefined} value={displayValue} onChange={onChangeMock} />)
  ...
  describe('Basic Interactions, float', () => {
    beforeEach(() => {
      displayValue = null
      utils = render(<CustomFormControl placeholder={undefined} value={displayValue} onChange={onChangeMock} float />)
      input = utils.getByLabelText('custom-input')
    })
  ...
  describe('allowEmpty', () => {
    beforeEach(() => {
      displayValue = null
      utils = render(<CustomFormControl placeholder={undefined} value={displayValue} onChange={onChangeMock} allowEmpty />)
      input = utils.getByLabelText('custom-input')
    })
