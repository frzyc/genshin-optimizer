...
export const allArtifactSets = [
  // Disable all Artifacts for Waverider. Order needs to be maintained.
...
export const allCharacterKeys = [
  // Disable all Characters for Waverider. Order needs to be maintained.
...
export const allWeaponKeys = [
  // Disable all Weapons for Waverider. Order needs to be maintained.
