...
describe("optimization", () => {
  ...
  describe("precomputing", () => {
    test("Base", () => {
      ...
      const [compute, buffer] = precompute([output1], x => x.path[0])
      buffer[0] = 32; buffer[1] = 77;
    ...
    test("Output is read node", () => {
      ...
      const [compute, buffer] = precompute([r1], x => x.path[0])
      buffer[0] = 32
    ...
    test("Output is constant node", () => {
      ...
      const [compute, buffer] = precompute([constant(35)], x => x.path[0])
    ...
    test("Output is duplicated", () => {
      ...
      const [compute, buffer] = precompute([output3, output3], x => x.path[0])
      buffer[0] = 2; buffer[1] = 44; buffer[2] = 7
